        	...
        	if(releases.length > 0)
        		if(releases.length > 5)
	        		...
	        		$.each(releases, function(itemIndex, item) {
						...
						$('#body').append('<tr class="release"><td scope="row" data-label="Vendor">Intense</td><td data-label="Release"><a href="' + itemURL + '" target="_blank">' + itemTitle + '</a></td><td data-label="Image"><img width="50" height="50" src="intense-records.png"/><td data-label="In Stock">' + itemStock + '</td><td data-label="Price">' + itemPrice + '</td></tr>');
	        		});
        	else
